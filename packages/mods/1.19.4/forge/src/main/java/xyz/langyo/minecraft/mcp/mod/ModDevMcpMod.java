...
public class ModDevMcpMod {
    ...
    private static void renderScreenButton(PoseStack ps, Minecraft mc, Screen screen) {
        ...
        if (ReflectionHelper.isMcpControlMode()) {
            ...
            McpOverlayLogic.renderResumeButton(wrapRenderer(ps, mc), mc.font, Component.translatable("mcpmod.control.resume").getString(), w, h, (int) mx, (int) my);
        } else if (!(screen instanceof PauseScreen)) {
            McpOverlayLogic.renderTransferButton(wrapRenderer(ps, mc), mc.font, Component.translatable("mcpmod.control.pause_button").getString(), w, h, (int) mx, (int) my);
        }
    }
            ...
            try {
                ...
                if (mc.screen == null) {
                    ...
                    if (ReflectionHelper.isMcpControlMode() && !ReflectionHelper.isScreenshotInProgress()) {
                        ...
                        double mx = getMouseX(mc);
                        double my = getMouseY(mc);
                        withFullScissor(() -> McpOverlayLogic.renderResumeButton(wrapRenderer(event.getPoseStack(), mc), mc.font, Component.translatable("mcpmod.control.resume").getString(), w, h, (int) mx, (int) my));
                    }
                }
            } catch (Exception ignored) {}
        });
