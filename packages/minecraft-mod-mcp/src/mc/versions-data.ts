...
const EMBEDDED_VERSIONS: VersionsData = {
  fg_eras: {
    ...
    fg12_gtnh: { key: "fg12_gtnh", fg_version: "com.github.GTNewHorizons:ForgeGradle:1.2.11", gradle: "4.4.1", plugin_id: "forge", java: 8, min_mc: "1.7.2", max_mc: "1.7.10", extra_repo: "https://jitpack.io" },
  ...
  versions: {
    "1_7_2": { forge: "1.7.2-10.12.1.1109", fg_era: "fg12_gtnh", java: 8, version_id: "1.7.2-forge10.12.1.1109-1.7.2" },
  ...
  api_groups: {
    ...
    "1.21.11": "mc26", "26.1.2": "mc26",
  },
  fabric_loom: {
    "1.14.4": "0.8-SNAPSHOT", "1.15.2": "0.8-SNAPSHOT", "1.16.5": "0.12-SNAPSHOT",
    "1.17.1": "1.0-SNAPSHOT", "1.18.2": "1.0-SNAPSHOT", "1.19.4": "1.3-SNAPSHOT",
    "1.20.6": "1.5-SNAPSHOT", "1.21.11": "1.14-SNAPSHOT", _default: "1.7-SNAPSHOT",
  },
  neoforge_gradle: { mdg_2_0_prefix: "2.0", mdg_2_0_gradle: "9.3.1", mdg_other_gradle: "8.10" },
  legacy: { eras: ["fg21", "fg22", "fg23", "fg3", "fg41"] },
};
