...
> **Необходимые условия**: Убедитесь, что демон Minecraft MCP запущен и клиент Minecraft с модом MCP подключён. Выполните `just daemon`, затем `just launch <version> <loader>`.
